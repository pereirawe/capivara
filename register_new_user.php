<?php include './functions.php';
    if (isset($_POST['submit'])) {
        ...
        if ($registered_user > 0) {
			echo '<img src="https://capivara.insoca.com.br/mail/mailtop.png" width="100%"><h1>¡El correo usuario ya esta registrado! </h1><br>
			<p>.</p><br>
			<a href="https://capivara.insoca.com.br/password_recover.php" title=""><small>Recuperar contraseña</small></a>';
		} else {
            $user_id = "u_" . uniqid();
            ...
            $user_registration_query = "INSERT INTO users (
                    ...
                    '',
                    '',
                    'https://capivara.insoca.com.br/img/default_profile.png',
                    'https://capivara.insoca.com.br/img/profile_banner.jpg',
                    '0',
					'',
					'',
					'https://capivara.insoca.com.br/img/default_pet.png',
					'',
					'',
					'',
					'',
            ...
            $cuerpo .= "<div style='text-align: center; background: #01BCC6; height: 80px;'>
                            <img src='https://capivara.insoca.com.br/img/main_logo.png' style='max-width: 100%; max-height: 80px;'>
                        </div>
                        <div style='padding:30px;'>
                            <h2>Bienvenido a VetStore</h2>
                            <p>Tu cuenta solo estará disponible después de ser activada: Para activarla, haz 
                                <a href='https://capivara.insoca.com.br/activation_new_user.php?user_id=". $user_id ."&user_security_token=". $user_security_token ."' target='new'>clic aquí</a>
                            </p>
                            <p>Su usuario es: <b>". $user_user_name ."</b></p>
                            <p>Su contraseña es: <b>". $decryptedpassword ."</b></p>
                            <div style='text-align: center; margin: 40px;'>
                                <a href='https://capivara.insoca.com.br/activation_new_user.php?user_id=". $user_id ."&user_security_token=". $user_security_token ."' target='new'>
                            ...
                            <p>Atentamente,</p>
                            <a href='https://capivara.insoca.com.br'>
                                <img src='https://capivara.insoca.com.br/img/logo-vetstore.png' height='65px'>
                            </a>
                            <br>
                        ...
                        <div style='margin-top: 20px; padding:30px; color: #ffffff; background-color: #54687A;'><strong>Copyright © 2020 Insoca.</strong> Todos los derechos reservados.</div>";
            $asunto = "Bienvenido a Capivara";
            $encabezado = "MIME-Version: 1.0" . "\r\n";
            $encabezado .= "Content-type:text/html;charset=UTF-8" . "\r\n";
            $encabezado .= "From: Insoca <noreply@insoca.com.br>" . "\r\n" .
                            "Reply-To: Insoca <info@insoca.com.br>" . "\r\n" .
        ...
        header('Location: https://capivara.insoca.com.br/');
    }
?>