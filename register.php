            ...
            <div class="row row-eq-height">
                ...
                <div id="home_form" class="col-md-6">
                    ...
                    ?>
                        ...
                        <div class="form-group">
                            <label for="reg_user_user_name">Email</label>
                            <input type="text" class="form-control" id="reg_user_user_name" name="reg_user_user_name" aria-describedby="reg_user_user_name" placeholder="Escribe tu nombre de usuario" required="required">
                        </div>
                    <?php
