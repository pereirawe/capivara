...
<head>
	...
	<script src="https://cdn.rawgit.com/michalsnik/aos/2.0.4/dist/aos.js"></script>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-118359105-1"></script>
		<script>
...
<body>
	<div id="header" class="container-fluid">
		<div class="row">
			<div id="left_seccion" class="col-md-4">
				<a href="https://www.facebook.com/VetStore-1855238388120599/" target="_blank"><i class="fab fa-facebook-square"></i></a>
				<a href="https://www.instagram.com/vetstore_fans/" target="_blank"><i class="fab fa-instagram"></i></a>
				<a href="https://plus.google.com/104324362474425707424" target="_blank"><i class="fab fa-google-plus-g"></i></a>
				<a href="https://twitter.com/Vet_Store?lang=es" target="_blank"><i class="fab fa-twitter-square"></i></a>
			</div>
			<div id="center_seccion" class="col-md-4">
				<a href="../welcome.php">
					<img id="header_logo" src="./img/logo_vetstore.png" alt="VetStore" >
				</a>
			</div>
			<div id="right_seccion" class="col-md-4">
