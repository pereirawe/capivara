    ...
    if(!isset($_SESSION['user_id'])){
        if (!isset($_SESSION['call_back_url'])) {
            if($actual_url != "https://capivara.insoca.com.br/register.php" &&
                substr($actual_url, 0, 36) != "https://capivara.insoca.com.br/fb_login.php" &&
                $actual_url != "https://capivara.insoca.com.br/login.php" &&
                $actual_url != "https://capivara.insoca.com.br/" &&
                $actual_url != "https://capivara.insoca.com.br/password_recover.php" &&
                $actual_url != "https://capivara.insoca.com.br/logout.php" ){
    ...
    */
    ...
    function reimg($img_file, $size){
        ...
        if( $img_file_limit > $size ){
            return "https://capivara.insoca.com.br/lab/reimg.php?img_file=". $img_file ."&size=". $size;
        } else {
            return $img_file;
        };
    };
        ...
        function search($search){
            ...
            while ($search_users = mysqli_fetch_array($result_search_users)){
                ...
                $search_users_display .= '<li class="list-group-item">
                        <a href="https://capivara.insoca.com.br/welcome.php?perfil='.$user_user_name.'" target="_new">
            ...
            if ($search != "") {
                ...
                while ($search_posts = mysqli_fetch_array($result_search_posts)){
                    ...
                    $search_posts_display .= '<li class="list-group-item">
                        <a href="https://capivara.insoca.com.br/welcome.php#bp_'.$post_id.'" target="_new">'.$post_content.'</a>
                        </li>';
